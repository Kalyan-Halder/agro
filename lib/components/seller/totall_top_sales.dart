...
class GlobalProductSalesPage extends StatefulWidget {
  final String user_id;

  GlobalProductSalesPage({required this.user_id});

  @override
  _GlobalProductSalesPageState createState() => _GlobalProductSalesPageState();
}

class _GlobalProductSalesPageState extends State<GlobalProductSalesPage> {
  Future<List<Map<String, int>>> fetchProductData() async {
    var response = await http.get(
      Uri.parse(top_products), // Replace '$get_graph' with your actual endpoint
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Product Sales (Global)', style: TextStyle(color: Colors.white)),
