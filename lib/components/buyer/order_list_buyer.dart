...
class OrderPageBuyer extends StatefulWidget {
  ...
  OrderPageBuyer({required this.user_id});

  @override
  _OrderPageBuyerState createState() => _OrderPageBuyerState();
}
...
class _OrderPageBuyerState extends State<OrderPageBuyer> {
  ...
  void getData(String buyer_id) async {
    print("getData called in manage page with user_id: $buyer_id");
    try {
      var response = await http.get(
        Uri.parse('$orders_buyer/$buyer_id'),
